...
class InceptionBlock(nn.Module):
    ...
    def __init__(self, in_channels, ch1x1, ch3x3_reduce, ch3x3, ch5x5_reduce, ch5x5, pool_proj):
        ...
        # Assign to an instance attribute called `branch_1` an object of type Sequential.
        ...
        # Assign to an instance attribute called `branch_2` an object of type Sequential.
        # The object must be constructed with 1x1 2D convolution, batch normalization, and ReLU,
        ...
        # Assign to an instance attribute called `branch_3` an object of type Sequential.
        # The object must be constructed with 1x1 2D convolution, batch normalization, and ReLU,
        ...
        # Assign to an instance attribute called `branch_4` an object of type Sequential.
